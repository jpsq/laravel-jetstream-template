<template>
    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 512 512" fill="none" id="iconWithBackground">
        ...
        <rect
            ...
            paint-order="stroke"
        />
        <rect width="488" height="488" x="12" y="12" fill="url(#glare)" rx="256" style="mix-blend-mode: overlay" />
        <defs>
            <linearGradient
        ...
        <svg xmlns="http://www.w3.org/2000/svg" width="370" height="370" viewBox="0 0 128 128" x="71" y="71">
            <path
                fill="#ffffff"
