    ...
    <ActionSection>
        ...
        <template #actions>
            <div class="flex items-center">
                <Button variant="destructive" :class="{ 'opacity-25': form.processing }" :disabled="form.processing" @click="confirmLogout">
            ...
            <DialogModal :show="confirmingLogout" @close="closeModal">
                ...
                <template #footer>
                    ...
                    <Button class="ms-3" :class="{ 'opacity-25': form.processing }" :disabled="form.processing" @click="logoutOtherBrowserSessions">
                        Log Out Other Browser Sessions
                    </Button>
                </template>
            </DialogModal>
